        ...
        <Box color="text.secondary">
            ...
            >
                ...
                <TabPanel value={value} index={2}>
                    ...
                    <SnackbarContent  className={classes.snackbar} message="John add a new mission." action={action} />
                    <ThemeProvider theme={theme}>
                        <SnackbarContent
                            icon={<AccountIcon />}
                            className={classes.snackbar}
                            message={
                                'JG add a new mission.'
                            }
                            action={action}
                        />
                    </ThemeProvider>
                    ...
                    <SnackbarContent
                        className={classes.snackbar}
                        message="Apple add a new mission."
                        action={action}
                    />
                    <SnackbarContent
                        className={classes.snackbar}
                        message={
                            'Lily add a new mission.'
                        }
                        action={action}
                    />
